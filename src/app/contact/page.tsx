...
export default function Contact() {
  ...
  return (
    <div className="section">
      <h1>Contact</h1>
      <p className="muted">Distributors, press/media, law enforcement, and bulk orders.</p>
      ...
      {submitted ? (
        ...
        <form onSubmit={handleSubmit} method="POST" action="https://formspree.io/f/mgvnzqdp" style={{display:"grid",gap:12,maxWidth:640}}>
          ...
          <button className="btn-primary" type="submit" disabled={state.submitting}>Send</button>
        </form>
      )}
      <div className="spacer" />
